...
!(function (t, e) {
	...
	function K(t, e) {
		...
		return (
			(i && !n ? e.contains(a) : e === a && 'BODY' !== a.nodeName) && (u = M(u, e)), u
		);
	}
	function G(t) {
	...
	function rt(t, e, n) {
		...
		var i = it(t),
			...
			c = r ? 'width' : 'height';
		return (
			(o[s] = e[s] + e[l] / 2 - i[l] / 2), (o[a] = n === a ? e[a] - i[c] : e[ot(a)]), o
		);
	}
	function st(t, e) {
		...
		kt = (function () {
			function t(e, n) {
				...
				W(this, t),
					...
					Object.keys(Y({}, t.Defaults.modifiers, o.modifiers)).forEach(function (
						e
					) {
